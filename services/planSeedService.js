  ...
  for (const plan of plans) {
      ...
      const ins = await db.query(
        `INSERT INTO subscription_products
          (name, description, target_role, price, billing_interval, code, sort_order, trial_days,
           max_properties, max_contacts, max_viewers, max_team_members, is_active)
         VALUES ($1, $2, $3, $4, 'month', $5, $6, $7, $8, $9, $10, $11, true)
         RETURNING id`,
        [
          name,
          description || `${name} plan for ${targetRole}s`,
    ...
    await db.query(
      `INSERT INTO plan_limits
        (subscription_product_id, max_properties, max_contacts, max_viewers, max_team_members, ai_token_monthly_quota, other_limits, updated_at)
